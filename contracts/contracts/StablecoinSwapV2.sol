 ...
 * - Liquidity providers earn configurable fee on swaps
 * - LP tokens represent share of liquidity pool
 * - Owner can update exchange rate and swap fee
 */
contract StablecoinSwapV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    // Swap fee in basis points (configurable by owner)
    uint256 public swapFeeBps = 20; // Default 0.2% = 20 basis points
    uint256 public constant BPS_DENOMINATOR = 10000;
    uint256 public constant MAX_SWAP_FEE_BPS = 100; // Max 1% fee
     ...
     * @param newFeeBps New fee in basis points (e.g., 10 = 0.1%)
     */
    ...
    function getEurcOut(uint256 usdcIn) public view returns (uint256 eurcOut, uint256 fee) {
        ...
        // Apply fee
        fee = (rawOut * swapFeeBps) / BPS_DENOMINATOR;
        eurcOut = rawOut - fee;
    }

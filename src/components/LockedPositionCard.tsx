    ...
    >
      ...
      <div className="absolute top-4 right-4">
        {isUnlocked ? (
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/20 border border-primary/50">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              size="sm"
              onClick={() => onClaimYield?.(position.id)}
              disabled={isClaiming || position.earnedYield === 0}
            ...
            <Button
              ...
              disabled={isWithdrawing || !isUnlocked}
              className={cn(
                isUnlocked &&
          ...
          {/* Early Withdraw Button - only show when locked */}
          {!isUnlocked && (
            <Button
              variant="outline"
              size="sm"
